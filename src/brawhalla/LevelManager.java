    ...
    public class LevelManager {
        ...
        public ArrayList<PlatForms> getPlatforms() {
            ...
            switch (currentLevel) {
                case 1:
                    ...
                    list.add(new PlatForms(0, -2, 25, 2, "Assets/Levels/level3/PlatForm1.png")); // كان 25 -> 30
                   break;

                case 2:
                    list.add(new PlatForms(0, -2, 25, 2, "Assets/Levels/level1/platform3.png")); // كان 30 -> 35
                    break;

                case 3:
                    list.add(new PlatForms(0, -2, 25, 2, "Assets/Levels/Boss level/PlatForm.png")); // كان 30 -> 35
                  break;
            }
            return list;
        }
        ...
        public void drawPlatforms(GL gl) {
            // رسم المنصات فقط
            if (platforms != null) {
                for (PlatForms p : platforms) {
                    if (p != null) {
